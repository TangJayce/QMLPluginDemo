...
//}
//
//void MozaTreeModel::toggleHide(int n)
//{
//    if (n < 0 || n >= m_currentItems.size()) { return; }
//
//    auto &currentItem = m_currentItems[n];
//    bool isParentHidden = false;
//    auto parent = currentItem.value->parentNode();
//    while (parent != m_tree->getRoot()) {
//        if (m_hiddenItems.contains(parent)) {
//            isParentHidden = true;
//            break;
//        }
//        parent = parent->parentNode();
//    }
//    if (currentItem.hideStatus == ENABLE) {
//        m_hiddenItems.remove(currentItem.value);
//        if (isParentHidden) {
//            currentItem.hideStatus = SUB_ENABLE;
//            emit dataChanged(createIndex(n, 0), createIndex(n, 0), {HIDE_STATUS});
//        } else {
//            currentItem.hideStatus = NONE;
//            int lastIndex = n;
//            if (currentItem.value->hasChild() && currentItem.expanded) {
//                int last = lastChildIndex(currentItem.value->child(currentItem.value->childCount() - 1));
//                int idx = n + 1;
//                while (idx <= last) {
//                    auto &item = m_currentItems[idx];
//                    if (item.hideStatus == ENABLE) {
//                        if (item.value->hasChild() && item.expanded) {
//                            int subLastIndex = lastChildIndex(item.value->child(item.value->childCount() - 1));
//                            idx = subLastIndex + 1;
//                        } else {
//                            ++idx;
//                        }
//                    } else {
//                        item.hideStatus = NONE;
//                        lastIndex = qMax(lastIndex, idx);
//                        ++idx;
//                    }
//                }
//            }
//            emit dataChanged(createIndex(n, 0), createIndex(lastIndex, 0), {HIDE_STATUS});
//        }
//    } else {
//        m_hiddenItems.insert(currentItem.value);
//        currentItem.hideStatus = ENABLE;
//        if (isParentHidden) {
//            emit dataChanged(createIndex(n, 0), createIndex(n, 0), {HIDE_STATUS});
//        } else {
//            int lastIndex = n;
...
//                for (int i = n + 1; i <= subLastIndex; ++i) {
//                    auto &item = m_currentItems[i];
//                    if (item.hideStatus == NONE) {
//                        item.hideStatus = SUB_ENABLE;
//                        lastIndex = qMax(lastIndex, i);
//                    }
//                }
//            }
...
//}
//
//void MozaTreeModel::toggleLock(int n)
//{
//    if (n < 0 || n >= m_currentItems.size()) { return; }
//
//    auto &currentItem = m_currentItems[n];
...
//    auto parent = currentItem.value->parentNode();
//    while (parent != m_tree->getRoot()) {
//        if (m_lockedItems.contains(parent)) {
//            isParentLocked = true;
//            break;
//        }
//        parent = parent->parentNode();
//    }
//    if (currentItem.lockStatus == ENABLE) {
//        m_lockedItems.remove(currentItem.value);
//        if (isParentLocked) {
//            currentItem.lockStatus = SUB_ENABLE;
//            emit dataChanged(createIndex(n, 0), createIndex(n, 0), {LOCK_STATUS});
//        } else {
//            currentItem.lockStatus = NONE;
//            int lastIndex = n;
//            if (currentItem.value->hasChild() && currentItem.expanded) {
//                int last = lastChildIndex(currentItem.value->child(currentItem.value->childCount() - 1));
//                int idx = n + 1;
...
//                        }
//                    } else {
//                        item.lockStatus = NONE;
//                        lastIndex = qMax(lastIndex, idx);
//                        ++idx;
//                    }
//                }
//            }
//            emit dataChanged(createIndex(n, 0), createIndex(lastIndex, 0), {LOCK_STATUS});
//        }
//    } else {
//        m_lockedItems.insert(currentItem.value);
//        currentItem.lockStatus = ENABLE;
//        if (isParentLocked) {
//            emit dataChanged(createIndex(n, 0), createIndex(n, 0), {LOCK_STATUS});
//        } else {
//            int lastIndex = n;
...
//                for (int i = n + 1; i <= subLastIndex; ++i) {
//                    auto &item = m_currentItems[i];
//                    if (item.lockStatus == NONE) {
//                        item.lockStatus = SUB_ENABLE;
//                        lastIndex = qMax(lastIndex, i);
//                    }
//                }
//            }
